...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[600px] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        >
          <div className="absolute w-[100%] left-0 bg-slate-950/80 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        ...
        >
          ...
          <div className="absolute w-[100%] right-0 bg-slate-950/80 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-slate-950/70 blur-2xl"></div>
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-slate-950/70"></div>
      </div>
