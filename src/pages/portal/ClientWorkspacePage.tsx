...
import { Loader2, AlertCircle, CheckCircle2, Clock, Rocket, FileText, Upload, Image, Palette, MapPin, Phone, Calendar, ClipboardList, LucideIcon } from "lucide-react";
...
/**
 * ClientWorkspacePage - Client-only view (/c/:token)
 * This route ALWAYS hides operator controls, even if admin_key exists in localStorage.
 * Use /w/:token for operator access.
 */
export default function ClientWorkspacePage() {
  ...
  return (
    <div className="h-screen flex flex-col">
      {/* Status banner - NO operator badge */}
      {projectInfo && (
      ...
      {/* Workspace - FORCED CLIENT MODE (no operator panel) */}
